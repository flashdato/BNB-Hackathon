...
async function main() {
  ...
  const contract = await sdk.getContract(
    "0x1833AC111fd43Ab9eD6917C521cd19E322899666"
  );
  data = await contract.erc20.balanceOf(accounts[0]);
  console.log("Your balance is: " + data.value.toString());
}
...
showTextBtn.addEventListener("click", function () {
  if (num % 2 == 0) {
    ...
    mySpan.innerText = data.value.toString();
